...
import com.backlogr.services.core.clients.AtlassianAuthClient;
import com.backlogr.services.core.clients.AtlassianResourceClient;
...
public class JiraOAuthService {
    ...
    public Result<AuthTokens> refreshAccessToken(String refreshToken) {
        try {
            ...
            return Result.ok(new AuthTokens(tokens.accessToken(), newRefreshToken, expiry));
        } catch (Exception e) {
